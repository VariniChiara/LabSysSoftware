		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t06",targetState="loadPlan",cond=whenDispatch("doPlan"))
				}	 
				...
				state("doPlan") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t17",targetState="doPlan1",cond=whenTimeout("local_tout_planexecutor_doPlan"))   
					transition(edgeName="t18",targetState="stopAppl",cond=whenDispatch("stopCmd"))
				}	 
				...
				state("attempttogoahead") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t29",targetState="stepDone",cond=whenDispatch("stepOk"))
					transition(edgeName="t210",targetState="stepFailed",cond=whenDispatch("stepFail"))
				}	 
