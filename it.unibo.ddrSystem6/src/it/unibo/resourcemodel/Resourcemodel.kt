		...
		return { //this:ActionBasciFsm
				...
				state("waitModelChange") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t026",targetState="changeModel",cond=whenDispatch("modelChange"))
					transition(edgeName="t027",targetState="updateModel",cond=whenDispatch("modelUpdate"))
				}	 
