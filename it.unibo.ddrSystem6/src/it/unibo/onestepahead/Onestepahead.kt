		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t016",targetState="doMoveForward",cond=whenDispatch("onestep"))
				}
				state("doMoveForward") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t117",targetState="endDoMoveForward",cond=whenTimeout("local_tout_onestepahead_doMoveForward"))
					transition(edgeName="t118",targetState="stepFail",cond=whenEvent("sonar"))
				}
